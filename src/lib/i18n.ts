...
export const STR: Record<string, Entry> = {
  ...
  proof_adm_title: { vi: 'Bằng chứng dùng thật', en: 'Proof of real use' },
  proof_adm_sub: { vi: 'Đăng ảnh thứ hạn upload theo ngày — hiện ngay trên trang chủ.', en: 'Publish daily upload-rank screenshots — they appear on the landing page.' },
  proof_adm_day: { vi: 'Ngày', en: 'Day' },
  proof_adm_rank: { vi: 'Thứ hạng', en: 'Rank' },
  proof_adm_image: { vi: 'Ảnh chụp', en: 'Screenshot' },
  proof_adm_publish: { vi: 'Đăng', en: 'Publish' },
  proof_adm_uploading: { vi: 'Đang tải lên…', en: 'Uploading…' },
  proof_adm_delete: { vi: 'Xoá mục này', en: 'Delete this entry' },
  proof_adm_empty: { vi: 'Chưa có mục nào.', en: 'No entries yet.' },
  proof_adm_col_image: { vi: 'Ảnh', en: 'Image' },
  proof_adm_col_action: { vi: 'Thao tác', en: 'Action' },
  proof_err_forbidden: { vi: 'Bạn không có quyền đăng mục này.', en: 'You are not allowed to publish here.' },
  proof_err_bad_day: { vi: 'Ngày không hợp lệ.', en: 'That date is not valid.' },
  proof_err_bad_rank: { vi: 'Thứ hạng phải là số nguyên từ 1 trở lên.', en: 'Rank must be a whole number of 1 or more.' },
  proof_err_no_image: { vi: 'Hãy chọn một ảnh.', en: 'Pick an image first.' },
  proof_err_too_big: { vi: 'Ảnh quá lớn (tối đa 2MB sau khi nén).', en: 'Image is too large (2MB max after compression).' },
  proof_err_bad_type: { vi: 'Chỉ nhận PNG, JPEG hoặc WebP.', en: 'Only PNG, JPEG or WebP is accepted.' },
  proof_err_not_found: { vi: 'Mục này không còn tồn tại.', en: 'That entry no longer exists.' },
  proof_err_server: { vi: 'Lỗi máy chủ, thử lại sau.', en: 'Server error, try again.' },
  lp_proof_title: { vi: 'Bằng chứng dùng thật', en: 'Proof of real use' },
  lp_proof_sub: { vi: 'Ảnh chụp thứ hạn upload thật, cập nhật theo ngày.', en: 'Real upload-rank screenshots, updated by day.' },
  lp_proof_rank: { vi: 'hạng', en: 'rank' },
